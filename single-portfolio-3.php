	...
	if( $images ): ?>
	 <?php foreach( $images as $key=>$image ) { 
	 		...
	 		if ($key === 0) { ?>
	 			...
	 			<div class="row noHeight middle-md center-md">
					<div class="col-xs-12 col-md-11 col-lg-6">
						<div class="half-height tile" style="background: url('<?php echo $image['sizes']['large']; ?>') center center;  background-size: cover; -webkit-background-size: cover; -moz-background-size: cover; width: 100%;">
						</div>	
					</div>
				</div>
